...
const page = () => {
  return (
    <main className=" max-w-5xl mx-auto py-10 flex flex-col gap-3 pt-28 px-10">
      <NavBar />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Zulkifl Health.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Zulkifl Health, accessible from{" "}
            <a
              href="https://zulkifl-health-products.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://zulkifl-health-products.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: zulkifl-health-products@gmail.com</li>
      </ul>
      <Footer/>
    </main>
  );
